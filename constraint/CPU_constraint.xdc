...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
 set_property PACKAGE_PIN W7 [get_ports {GPIO_0[0]}];  # "JD1_N"
 set_property PACKAGE_PIN V7 [get_ports {GPIO_0[1]}];  # "JD1_P"
 set_property PACKAGE_PIN V4 [get_ports {GPIO_0[2]}];  # "JD2_N"
 set_property PACKAGE_PIN V5 [get_ports {GPIO_0[3]}];  # "JD2_P"
 set_property PACKAGE_PIN W5 [get_ports {GPIO_0[4]}];  # "JD3_N"
 set_property PACKAGE_PIN W6 [get_ports {GPIO_0[5]}];  # "JD3_P"
 set_property PACKAGE_PIN U5 [get_ports {GPIO_0[6]}];  # "JD4_N"
 set_property PACKAGE_PIN U6 [get_ports {GPIO_0[7]}];  # "JD4_P"
